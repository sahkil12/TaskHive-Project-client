  ...
  return (
    <div className="bg-base-300">
      ...
      <div className="rail px-2 flex flex-col justify-center items-center text-center gap-6">
        ...
        <p className="text-base/normal tracking-tight md:tracking-wide font-medium opacity-95 md:text-lg">
      ...
      <div className="w-full p-2 md:w-11/12 mx-auto grid grid-cols-1 sm:grid-cols-8 gap-3 py-10">
        ...
        <section className="sm:sticky h-fit top-28 sm:col-span-2 py-4 p-1 md:px-3 w-full">
          <h2 className="text-white font-semibold bg-primary/90 py-3 rounded-lg text-center text-base md:text-xl ">
            Task Category
          </h2>
          <ul className="space-y-2 py-2">
            {categories?.map((cat) => (
              <li
                ...
                key={cat.id}
                className={`px-4 py-2 rounded-sm border text-base md:text-lg text-center font-semibold hover:bg-primary/5 border-neutral-300 cursor-pointer ${
