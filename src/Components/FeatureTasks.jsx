        ...
        <div className="py-10 rail bg-base-100 p-5">
            ...
            <div className="py-6 px-2 my-8 md:w-11/12 mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {
                        tasks.map(task => <Link to={`taskDetails/${task._id}`} key={task._id} className="border-2 flex flex-col shadow-lg gap-5 w-full border-neutral-200 p-6 rounded-2xl bg-base-200/50 hover:shadow-xl hover:-translate-y-1.5 duration-300 cursor-pointer">
                            {/* Icon */}
