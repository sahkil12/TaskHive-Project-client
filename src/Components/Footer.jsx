...
const Footer = () => {
  return (
    <footer className="rounded-t-2xl border-t-3 border-primary/20 bg-base-200 text-slate-600 py-12 px-6 shadow-inner pop">
      <div className="lg:max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-10">
        ...
        <div className="flex flex-col items-center md:items-start gap-4">
          <div className="flex items-center gap-2">
            ...
            <Link
              to={"/"}
              className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-indigo-600 to-sky-600 bg-clip-text text-transparent logo"
            >
              TaskHive
            </Link>
          </div>
        ...
        <form className="flex flex-col gap-3">
          ...
          <div className="join">
            <input
              ...
              className="input input-bordered join-item w-full md:w-full bg-white border-neutral-300"
            />
