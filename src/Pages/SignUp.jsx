    ...
    <div className="px-2 bg-primary/5 ">
        <nav className="flex flex-col items-center py-8 px-4 gap-3 md:flex-row justify-between">
          ...
          <div className="flex items-center gap-3">
           ...
           <p className="text-center font-medium text-lg">Already Have An Account ? <Link to={'/auth/login'} className="btn btn-primary text-base px-6 font-semibold ">Login</Link></p>
        </nav>
      ...
      <div className="w-full mx-auto max-w-6xl my-3 border-2 border-neutral-200 p-4 rounded-md shadow sm:p-8 rail">
        ...
        <div className="flex items-center w-full my-4">
          ...
          <p className="px-3 w-full text-gray-700 text-center">Or signUp with e-mail</p>
          <hr className="w-full dark:text-gray-600" />
        </div>
        {/* sign up form */}
